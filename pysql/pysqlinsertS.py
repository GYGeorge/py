# /*
#  * @Author: gaoyuan 
#  * @Date: 2020-07-03 07:53:47 
#  * @Last Modified by:   gaoyuan 
#  * @Last Modified time: 2020-07-03 07:53:47 
#  */
import random
import pandas as pd
import pymysql
...
sex = ["男", "女"]
dept = ["cs", "ee", "ma", "art", "law", "wd", "eco", "edu", "liter", "phy", "chem", "astron",
        "marine", "geo", "bio", "botany", "zoo", "mech", "car", "helico", "nuclear", "agri",
        "plane", "weapon", "animal", "fisher", "medicine", "stoma", "military", "manage", "social",
        "land", "library", "archival", "war", "surgery", "sports", "neuro", "immu", "clinical", "aero"]
...
for i in range(1001, 1000000):
    ...
    ssex = sex[random.randint(0, 1)]
    sdept = dept[random.randint(0, len(dept) - 1)]
    age = random.randint(18, 23)
    temp = [no, name, ssex, age, sdept]
    # print(temp)
    insertsql = "INSERT INTO s(Sno,Sname,Ssex,Sage,Sdept) VALUES('%s','%s','%s','%d','%s')" % (
        no, name, ssex, age, sdept)
